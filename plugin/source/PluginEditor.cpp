...
AudioPluginAudioProcessorEditor::AudioPluginAudioProcessorEditor(
    ...
    : AudioProcessorEditor(&p), processorRef(p), m_FreqSliderAttachment(processorRef.getState(),"freqHz",m_FreqSlider), m_ButtonAttachment(processorRef.getState(),"play",m_PlayButton) {
  ...
  m_PlayButton.setToggleState(true,juce::NotificationType::dontSendNotification);
  m_PlayButton.setClickingTogglesState(true);

  m_PlayButton.setColour(juce::TextButton::ColourIds::buttonOnColourId,juce::Colours::green);
  m_PlayButton.setColour(juce::TextButton::ColourIds::buttonColourId,juce::Colours::red);
...
void AudioPluginAudioProcessorEditor::resized() {
  ...
  m_FreqLabel.setBounds(getWidth() / 2 - 50, getWidth() / 2 - 120, 100, 20);
